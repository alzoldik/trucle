...
//
//     final getPaidPaymentModel = getPaidPaymentModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

GetPaidPaymentModel getPaidPaymentModelFromJson(String str) => GetPaidPaymentModel.fromJson(json.decode(str));

String getPaidPaymentModelToJson(GetPaidPaymentModel data) => json.encode(data.toJson());

class GetPaidPaymentModel {
    GetPaidPaymentModel({
    ...
    factory GetPaidPaymentModel.fromJson(Map<String, dynamic> json) => GetPaidPaymentModel(
