...
//
//     final activatedOrdeModel = activatedOrdeModelFromJson(jsonString);

import 'dart:convert';

ActivatedOrdeModel activatedOrdeModelFromJson(String str) => ActivatedOrdeModel.fromJson(json.decode(str));

String activatedOrdeModelToJson(ActivatedOrdeModel data) => json.encode(data.toJson());

class ActivatedOrdeModel {
    ActivatedOrdeModel({
        this.mainCode,
        this.code,
        this.data,
    ...
    factory ActivatedOrdeModel.fromJson(Map<String, dynamic> json) => ActivatedOrdeModel(
