...
//
//     final creatOrderModel = creatOrderModelFromJson(jsonString);

import 'dart:convert';

CreatOrderModel creatOrderModelFromJson(String str) => CreatOrderModel.fromJson(json.decode(str));

String creatOrderModelToJson(CreatOrderModel data) => json.encode(data.toJson());
