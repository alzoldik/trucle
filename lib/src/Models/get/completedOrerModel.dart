...
//
//     final completedOrdeModel = completedOrdeModelFromJson(jsonString);

import 'dart:convert';

CompletedOrdeModel completedOrdeModelFromJson(String str) =>
    CompletedOrdeModel.fromJson(json.decode(str));

String completedOrdeModelToJson(CompletedOrdeModel data) =>
    json.encode(data.toJson());

class CompletedOrdeModel {
  CompletedOrdeModel({
    this.mainCode,
    this.code,
    this.data,
  ...
  factory CompletedOrdeModel.fromJson(Map<String, dynamic> json) =>
      CompletedOrdeModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        code: json["code"] == null ? null : json["code"],
        travelLongitude:
            json["travel_longitude"] == null ? null : json["travel_longitude"],
        travelLatitude:
            json["travel_latitude"] == null ? null : json["travel_latitude"],
        travelAddress:
            json["travel_address"] == null ? null : json["travel_address"],
        arrivalLongitude: json["arrival_longitude"] == null
            ? null
            : json["arrival_longitude"],
        arrivalLatitude:
            json["arrival_latitude"] == null ? null : json["arrival_latitude"],
        arrivalAddress:
            json["arrival_address"] == null ? null : json["arrival_address"],
        ...
        rateState: json["rate_state"] == null ? null : json["rate_state"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "rate_state": rateState == null ? null : rateState,
